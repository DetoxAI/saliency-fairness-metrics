...
from lrp import ConditionOn, LRPHandler
...
class XAIMetricsCalculator:
    """
    Class to calculate XAI metrics for a given model and sailmaps
    """

    def __init__(
        self, dataloader: DataLoader, lrphandler: LRPHandler, n_classes: int
    ) -> None:
        self.dataloader: WrappedDataLoader = WrappedDataLoader(
            dataloader.dataset, n_classes, batch_size=dataloader.batch_size
        )
